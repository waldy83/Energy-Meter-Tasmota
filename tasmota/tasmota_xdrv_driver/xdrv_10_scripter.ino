...
#include <sml_scripts.h>   // CHANGED BY WALDY
                      ...
                      if (sysv_type) {
                        switch (sysv_type) {
                          ...
                          case SCRIPT_TELEPERIOD:
                            // if (*dfvar < 10) *dfvar = 10;	// CHANGED BY WALDY
							if (*dfvar < 1) *dfvar = 1;			// CHANGED BY WALDY
...
const char HTTP_FORM_SCRIPT1[] PROGMEM =
	...
	SCRIPT_SML_SELECT	// CHANGED BY WALDY
    SCRIPT_LIST_SELECT
...
const char HTTP_FORM_SCRIPT1b[] PROGMEM =
	...
	SCRIPT_SML_SELECT_HANDLER	// CHANGED BY WALDY
